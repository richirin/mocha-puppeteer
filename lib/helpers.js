...
const {generateEmail, generateNumbers} = require('./utils')
const config = require('./config')

module.exports = {
    login: async function(page, phoneNumber) {
        ...
        await page.type('#input-daftar', phoneNumber)
    ...
    createNewAccount : async function(page){
        await page.goto(process.env.BASE_URL, { waitUntil: 'networkidle0' })
        ...
        await page.waitForSelector('#input-daftar')
        await page.type('#input-daftar', '+628' + generateNumbers())
        ...
        await page.type('#register-name', config.userFore)

        await page.waitForSelector('#register-email')
        await page.type('#register-email', generateEmail())

        await page.waitForSelector('#register-button-submit')
        await page.click('#register-button-submit')
